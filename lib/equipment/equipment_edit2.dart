...
class EquipmentEdit2 extends StatelessWidget {
  EquipmentEdit2({Key? key, required this.equipment, required this.viewList, required this.plotList}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: appBar(context, 'Карточка оборудования', {}, null),
                    ...
                    child: FormBuilder(
                      ...
                      child: Column(
                        children: [
                          ...
                          IconButton(onPressed: () {}, icon: SvgPicture.asset('assets/icon.svg', fit: BoxFit.scaleDown)),
                          AppSixeBox.size16,
//-------------------------------------------------------------------------------------------------------------------------------
...
//-------------------------------------------------------------------------------------------------------------------------------
                          AppButton.filledButton('Сохранить', onPressed: () {
                            ...
                            print('=====================================================');
                            print(formInfoKey.currentState?.value.toString());
/*
