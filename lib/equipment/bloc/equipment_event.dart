...
class EquipmentEvent with _$EquipmentEvent {
  ...
  const factory EquipmentEvent.gotoDetailScreen(String equipmentid) = _GotoDetailScreenEvent;
  ...
  const factory EquipmentEvent.gotoCalendarScreen(Equipment equipment) = _GotoCalendarScreenEvent;
