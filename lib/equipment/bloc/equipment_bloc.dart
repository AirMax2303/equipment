...
class EquipmentBloc extends Bloc<EquipmentEvent, EquipmentState> {
  ...
  void _onGotoDetailScreenEvent(
    ...
    emit(EquipmentState.gotoDetailScreen(equipment: event.equipment,));
  }
  ...
  void _onGotoEditScreenEvent(
    ...
    emit(EquipmentState.gotoEditScreen(equipment: event.equipment, viewList: await service.getViewList(), plotList: await service
        .getPlotList(), infoList: await service.getInfoList(event.equipment.id!)));
  }
