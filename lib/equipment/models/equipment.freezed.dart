...
class _$_EquipmentModel implements _EquipmentModel {
  ...
  @override
  String toString() {
    return 'EquipmentModel(id: $id, clientid: $clientid, view: $view, plot: $plot, name1: $name1, name2: $name2, image: $image, status: $status, proftype: $proftype, valueproftype: $valueproftype)';
  }
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.valueproftype, valueproftype) ||
                other.valueproftype == valueproftype));
  }

  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, id, clientid, view, plot, name1,
      name2, image, status, proftype, valueproftype);
